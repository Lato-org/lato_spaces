  ...
  module SpacesHelper
    ...
    def lato_spaces_space_actions(space)
      content_tag(:div, class: 'btn-group btn-group-sm') do
        concat link_to('Members', lato_spaces.members_space_path(space), class: 'btn btn-primary', data: { lato_action_target: 'trigger', turbo_frame: dom_id(space, 'members'), action_size: 'xl', action_title: 'Space members' })
        concat link_to('Edit', lato_spaces.edit_space_path(space), class: 'btn btn-secondary', data: { lato_action_target: 'trigger', turbo_frame: dom_id(space, 'form'), action_title: 'Edit space' })
    ...
    def lato_spaces_space_member_lato_user_id(space_member)
      lato_data_user space_member.full_name
    end
  end
end
